...
namespace MyVet.WebApp.Migrations
{
    ...
    [Migration("20190904210309_Users")]
    partial class Users
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVet.WebApp.Data.Entities.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyVet.WebApp.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyVet.WebApp.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVet.Web.Data.Entities.Owner", b =>
                {
                    b.HasOne("MyVet.WebApp.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
